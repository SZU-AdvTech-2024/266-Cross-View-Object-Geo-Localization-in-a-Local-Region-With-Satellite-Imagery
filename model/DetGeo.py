...
class DetGeo(nn.Module):
    ...
    def forward(self, query_imgs, reference_imgs, mat_clickptns):
        ...
        # print("query_fvisu:{}".format(query_fvisu.shape))
        # print("reference_fvisu:{}".format(reference_fvisu.shape))
...
if __name__ == '__main__':
    ...
    model = DetGeo().to(device)
    query_imgs = torch.randn(1, 3, 256, 256).to(device)
    reference_imgs = torch.randn(1, 3, 1024, 1024).to(device)
